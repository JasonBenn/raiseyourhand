...
var CreateLesson = {
    ...
    addNewContentToPlaylist: function () {
        ...
        $('.playlist-container').append('<li class="playlist-content switch-video-content-clip" data-content-id=' + content.id + ' style="background-color:#' + CreateLesson.getColor(content.position) + '">' + content.title + '<i class="icon-sort sort-order-placement-draggable"></i></li>');
    },
    ...
    update_full_lesson_timeline_bar: function () {
        ...
        timeline.forEach(function (element, index) {
            ...
            $('.full-lesson-timeline').append('<li class="timeline-portion switch-video-content-clip ' + 'timeline-portion-id-' + element.position + '" style="width:' + percent_filled + '%; background-color:#' + CreateLesson.getColor(index) + '" data-content-id=' + element.id + '>' + '</li>');
        });
    },
    ...
    initializePlaylist: function () {
        ...
        timeline.forEach(function (content, index) {
            ...
            html += ('<li class="playlist-content switch-video-content-clip" data-content-id=' + content.id + ' style="background-color:#' + CreateLesson.getColor(index) + '">' + title + '<i class="icon-sort sort-order-placement-draggable"></i></li>');
        });
